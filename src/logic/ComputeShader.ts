...
export const defaultBufferInfo = twgl.createBufferInfoFromArrays(getWebGLContext(), {
	position: {
...
export class ComputeShader implements twgl.ProgramInfo {
	public readonly program: WebGLProgram;
	public readonly uniformSetters: { [key: string]: (...params: any[]) => any };
	public readonly attribSetters: { [key: string]: (...params: any[]) => any };
	public readonly transformFeedbackInfo?: { [key: string]: twgl.TransformFeedbackInfo };
	...
	constructor(fragShader: string, fragVariables?: FragVariables, vertShader?: string) {
		...
		const prog = twgl.createProgramInfo(getWebGLContext(), [vertShader ? vertShader : passThruVert, fragShader]);
